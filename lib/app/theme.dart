...
class AppTheme {
  static const Color cBg = Color(0xFFF0F9FF);
  static const Color cSurface = Color(0xFFFFFFFF);
  static const Color cEdge = Color(0xFFBAE6FD);
  static const Color cAccent = Color(0xFF0284C7);
  static const Color cAccent2 = Color(0xFF38BDF8);
  static const Color cInk = Color(0xFF082F49);
